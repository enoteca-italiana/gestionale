...
- `refreshInventory()`:
  ...
  - sincronizza inventory da repository e aggiorna stato UI senza doppie scritture locali
- repository vini (`listWines()`):
  ...
  - persiste inventory solo se realmente cambiata (guard anti-write ridondanti)
