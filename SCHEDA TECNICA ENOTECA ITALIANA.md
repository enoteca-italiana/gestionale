...
- archivio admin (toolbar filtri):
  - funzione `Nota Scarico` rimossa dal runtime;
  - dominio `Fornitore` rimosso dal runtime applicativo;
...
- Sicurezza PIN admin:
  - modale unico con due controlli separati:
